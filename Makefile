...
BIN=bin/
SRC=src/
OBJS=${SRC}/clustercat-array.o ${SRC}/clustercat-io.o ${SRC}/clustercat-map.o ${SRC}/clustercat-math.o ${SRC}/clustercat-tokenize.o
...
clustercat.c: ${SRC}/clustercat.h ${SRC}/clustercat-io.h ${SRC}/clustercat-math.h ${SRC}/clustercat-tokenize.h
